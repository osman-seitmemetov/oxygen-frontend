...
import styles from "./AdminPromocodesItem.module.scss";
...
const AdminPromocodesItem: FC<AdminProductItemProps> = ({promocode, removeHandler, setActiveModal, activeModal}) => {
    console.log(promocode.categories)
    return (
        <>
            <div className={styles.item} key={promocode.id}>
                <div className={styles.left}>
                    <div className={styles.column}>
                        <div className={styles.title}>{promocode.title}</div>

                        <div className={styles.categories}>
                            <span>Категории: </span>
                            {separateByCommas(promocode.categories)}
                        </div>
                    </div>
                </div>
            ...
            <Modal
                title="Вы точно хотите удалить промокод?"
                active={activeModal}
...
export default AdminPromocodesItem;
