...
interface AdminTypesItemProps {
    type: IType,
    removeHandler: (typeId: string) => void,
    setActiveModal: (activeModal: boolean) => void,
    activeModal: boolean
}

const AdminTypesItem: FC<AdminTypesItemProps> = ({type, removeHandler, setActiveModal, activeModal}) => {
    return (
        <>
