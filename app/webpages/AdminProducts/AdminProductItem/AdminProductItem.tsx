...
const AdminProductItem: FC<AdminProductItemProps> = ({product, removeHandler, setActiveModal, activeModal}) => {
            ...
            <div className={styles.item} key={product.id}>
                ...
                <div className={styles.right}>
                    <div className={styles.date}>
                        Цена&nbsp;
                        <span>{product.isDiscount ? product.newPrice : product.price} руб.</span>
                    </div>
