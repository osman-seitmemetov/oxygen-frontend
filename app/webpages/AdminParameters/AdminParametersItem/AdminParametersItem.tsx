...
import styles from "./AdminParametersItem.module.scss";
...
const AdminParametersItem: FC<AdminCategoriesItemProps> = ({parameter, removeHandler, setActiveModal, activeModal}) => {
    return (
        <>
            <div className={styles.item}>
                ...
                <div className={styles.right}>
                    <Link
                        href={`/admin/parameters/${parameter.id}`}
                    >
            ...
            >
                ...
                >
                    <ButtonGreen
                        onClick={() => {
                            removeHandler(String(parameter.id));
...
export default AdminParametersItem;
