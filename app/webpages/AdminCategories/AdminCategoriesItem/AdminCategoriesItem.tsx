...
const AdminCategoriesItem: FC<AdminCategoriesItemProps> = ({category, removeHandler, setActiveModal, activeModal}) => {
    return (
        <>
            <div className={styles.item}>
                <div className={styles.left}>
                    {category.img && <img className={styles.img} src={category.img} alt={category.name}/>}
