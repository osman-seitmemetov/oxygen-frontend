...
import styles from "./AdminFilterGroupsItem.module.scss";
...
interface AdminCategoriesItemProps {
    ...
    removeHandler: (filterGroupId: string) => void,
    setActiveModal: (activeModal: boolean) => void,
    activeModal: boolean
}

const AdminFilterGroupsItem: FC<AdminCategoriesItemProps> = ({filterGroup, removeHandler, setActiveModal, activeModal}) => {
    return (
        <>
            <div className={styles.item}>
                ...
                <div className={styles.right}>
                    <Link
                        href={`/admin/filter_groups/${filterGroup.id}`}
                    >
            ...
            >
                ...
                >
                    <ButtonGreen
                        onClick={() => {
                            removeHandler(String(filterGroup.id));
...
export default AdminFilterGroupsItem;
