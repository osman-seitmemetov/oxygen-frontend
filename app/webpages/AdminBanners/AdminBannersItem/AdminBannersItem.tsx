...
const AdminBannersItem: FC<AdminBannersItemProps> = ({banner, removeHandler, setActiveModal, activeModal}) => {
    return (
        <>
            <div className={styles.item}>
                <div className={styles.left}>
                    <img className={styles.img} src={`http://localhost:5000/${banner.img}`} alt={banner.title}/>
...
export default AdminBannersItem;
