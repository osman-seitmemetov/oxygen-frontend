...
interface AdminBrandsItemProps {
    brand: IBrand,
    removeHandler: (brandId: string) => void,
    setActiveModal: (activeModal: boolean) => void,
    activeModal: boolean
}

const AdminBrandsItem: FC<AdminBrandsItemProps> = ({brand, removeHandler, setActiveModal, activeModal}) => {
    return (
        <>
            <div className={styles.item}>
                <div className={styles.left}>
                    <img className={styles.img} src={brand.logo} alt={brand.name}/>
...
export default AdminBrandsItem;
